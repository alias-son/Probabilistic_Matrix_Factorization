...
movies = pd.read_csv('C:/RecoSys/Data/movies_metadata.csv')
movies = movies[['id', 'title']]
credits = pd.read_csv('C:/RecoSys/Data/credits.csv')
keywords = pd.read_csv('C:/RecoSys/Data/keywords.csv')
credits.head()
keywords.head()
...
content_recommender2('The Lion King', cosine_sim2, movies, indices2)
